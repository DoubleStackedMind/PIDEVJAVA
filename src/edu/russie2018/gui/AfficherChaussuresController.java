 ...
 * @author Sami
 */
public class AfficherChaussuresController implements Initializable {
    ...
    Pagination page = new Pagination(round((ps.consulterProduitsParType("Chaussures").size() / 6) + 1));
    @FXML
        ...
        pageNumber.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if (Integer.parseInt(newValue) == 0) {
                    DisplayAllProducts(ps.consulterProduitsParType("Chaussures"), 0);
                }
                if (Integer.parseInt(newValue) == 1) {
                    DisplayAllProducts(ps.consulterProduitsParType("Chaussures"), 6);
                }
                if (Integer.parseInt(newValue) == 2) {
                    DisplayAllProducts(ps.consulterProduitsParType("Chaussures"), 12);
                }
                if (Integer.parseInt(newValue) == 3) {
                    DisplayAllProducts(ps.consulterProduitsParType("Chaussures"), 18);
                }
                if (Integer.parseInt(newValue) == 4) {
                    DisplayAllProducts(ps.consulterProduitsParType("Chaussures"), 24);
                }
