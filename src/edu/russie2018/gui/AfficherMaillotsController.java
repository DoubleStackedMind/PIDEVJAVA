 ...
 * @author Sami
 */
public class AfficherMaillotsController implements Initializable {
    ...
    Pagination page = new Pagination(round((ps.consulterProduitsParType("Maillot").size() / 6) + 1));
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        TousLesProduitsController tlpc = new TousLesProduitsController();
        myMap.putAll(tlpc.myMap);
        PanierNUM.setText(String.valueOf(tlpc.PanNUM));
        ...
        pageNumber.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if (Integer.parseInt(newValue) == 0) {
                    DisplayAllProducts(ps.consulterProduitsParType("Maillot"), 0);
                }
                if (Integer.parseInt(newValue) == 1) {
                    DisplayAllProducts(ps.consulterProduitsParType("Maillot"), 6);
                }
                if (Integer.parseInt(newValue) == 2) {
                    DisplayAllProducts(ps.consulterProduitsParType("Maillot"), 12);
                }
                if (Integer.parseInt(newValue) == 3) {
                    DisplayAllProducts(ps.consulterProduitsParType("Maillot"), 18);
                }
                if (Integer.parseInt(newValue) == 4) {
                    DisplayAllProducts(ps.consulterProduitsParType("Maillot"), 24);
                }
